...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true)
      clearError()
      const response = await authApi.login({ phone: fullPhone })
  ...
  return (
    <div className="min-h-screen bg-[#0e1621] flex flex-col items-center justify-center p-4">
      ...
      <div className="text-center mb-8">
        <div className="w-28 h-28 mx-auto mb-6 bg-[#3390ec] rounded-full flex items-center justify-center shadow-lg shadow-[#3390ec]/30">
        ...
        <p className="text-[#6c7883] text-base">Sign in to start messaging</p>
      </div>
      ...
      <div className="w-full max-w-md">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[#6c7883] text-sm text-center mt-3">
          ...
          <button
            ...
            className="w-full bg-[#3390ec] hover:bg-[#2b7fd4] disabled:bg-[#3390ec]/50 disabled:cursor-not-allowed text-white font-medium py-4 rounded-xl transition-colors flex items-center justify-center gap-2 text-base"
          >
            {isLoading ? (
        ...
        <p className="text-center mt-4 text-[#6c7883]">
          New to Telegram?{' '}
          <Link to="/register" className="text-[#3390ec] hover:underline font-medium">
            Create account
          </Link>
        </p>
      </div>
